...
public class BasicLocationTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(this,
            ...
            ActivityCompat.requestPermissions(this, //요청 메시지를 어디에 띄울 것인지
    ...
    public void startLocationService(){
        // getSystemService메소드에 서비스명을 적어주면 된다. (캐스팅 해줘야함)
        locationManager =
        ...
        try {
            ...
            if(location!=null){ // 실내에 있거나 에뮬레이터로 위치값을 받아오는 경우, 잘 안 될 수도 있기 때문
